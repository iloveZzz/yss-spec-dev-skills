...
- YSS UI components: `the consuming project's optional YSS documentation`
- YSS UI hooks: `the consuming project's optional YSS documentation`
- YSS UI skills: `the consuming project's optional YSS documentation`
