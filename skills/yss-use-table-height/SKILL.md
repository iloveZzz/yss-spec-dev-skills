...
- YSS UI hooks documentation: `the consuming project's optional YSS documentation`
...
> 💡 **完整参数和类型定义**请查阅：
> - 在线文档：`the consuming project's optional YSS documentation`
> - 源码类型：`packages/hooks/src/useTableHeight/types.ts`
> - LLM 索引：`the consuming project's optional YSS documentation`（搜索 "useTableHeight"）
