---
name: "yss-ui"
description: Use when YSS UI 页面开发组件技能。涉及 YTable、YTree、YssFormily、useTableHeight、useTreeHeight、页面布局、Hook 抽离、API 契约接入、路由菜单约定时必须使用。组件技能可以参考 yss-components 与 yss-hooks 技能规范。
---
...
- YSS UI 组件文档：`the consuming project's optional YSS documentation`
- YSS UI Hooks 文档：`the consuming project's optional YSS documentation`
- YSS UI Skills 文档：`the consuming project's optional YSS documentation`
