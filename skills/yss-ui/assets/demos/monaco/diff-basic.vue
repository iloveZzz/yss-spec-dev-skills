...
-- 插入初始数据
INSERT INTO users (username, password, status) VALUES ('admin', 'CHANGE_ME', 1);
INSERT INTO users (username, password, status) VALUES ('CHANGE_ME', 'CHANGE_ME', 1);
INSERT INTO users (username, password, status) VALUES ('tester', 'CHANGE_ME', 0);
