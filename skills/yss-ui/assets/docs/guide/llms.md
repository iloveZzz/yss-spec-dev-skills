...
```
@Docs the consuming project's optional YSS documentation
```
...
```
@ the consuming project's optional YSS documentation
```
...
3. 添加 `the consuming project's optional YSS documentation`
...
```bash
gemini --context the consuming project's optional YSS documentation "如何使用 YTable 组件？"
```
...
```markdown
## 相关文档
- YSS UI: the consuming project's optional YSS documentation
```
...
```
参考文档 the consuming project's optional YSS documentation
```
...
knowledge:
  external_docs:
    - url: the consuming project's optional YSS documentation
